...
Deploy Packitty using k3s (Lightweight Kubernetes) with Envoy proxy sidecar.

## Overview

This folder contains everything needed to deploy a Flask application on k3s with:
...
- **Ubuntu Deployment**: `../ubuntu/README.md`
